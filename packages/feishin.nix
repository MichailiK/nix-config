{
  ...
  src = fetchFromGitHub {
    owner = "MichailiK";
    repo = "feishin";
    rev = "6d6f7b70829208ef551e8283d80da34cc90e7d9a"; # michaili-patches
    hash = "sha256-aQOynt4MzQSHSzHTO7Ylrz7j6qHDJ3xqaYHuNumiCpA=";
  };
...
in
  buildNpmPackage {
    ...
    pnpmDeps = fetchPnpmDeps {
      ...
      pnpm = pnpm_11;
      fetcherVersion = 4;
      hash = "sha256-I+SdTrPYm+Jmz98ZuocOhJIQIBrfUEPSmegj+/PsqXs=";
    };
